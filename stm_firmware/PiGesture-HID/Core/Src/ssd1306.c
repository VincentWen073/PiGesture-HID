...
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    HAL_I2C_Mem_Write(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x40, 1, buffer, buff_size, 80);
}
...
volatile uint8_t oled_is_busy = 0;

void ssd1306_UpdateScreen_DMA(void) {
	if (oled_is_busy || HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY) return;
    oled_is_busy = 1;
    ...
    HAL_I2C_Mem_Write_DMA(&hi2c1, SSD1306_I2C_ADDR, 0x40, 1, SSD1306_Buffer, 1024);
}
